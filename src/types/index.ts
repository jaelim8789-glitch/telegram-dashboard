...
export const CATEGORY_META: Record<TabGroup, { label: string; icon: string }> = {
  dashboard: { label: "?Ä?úÎ≥¥??, icon: "LayoutDashboard" },
  send: { label: "Î∞úÏÜ°", icon: "Send" },
  ops: { label: "?¥ÏòÅ", icon: "Activity" },
  ai: { label: "AI", icon: "Sparkles" },
  settings: { label: "?§Ï†ï", icon: "Settings" },
  new: { label: "?†Í∑ú", icon: "Plus" },
};
...
export const TABS: TabDef[] = [
  // ?Ä?Ä ?Ä?úÎ≥¥??(ÏµúÏÉÅ???®ÎèÖ) ?Ä?Ä
  { id: "dashboard", label: "?Ä?úÎ≥¥??, shortLabel: "?Ä??, group: "dashboard" },

  // ?Ä?Ä Î∞úÏÜ° ?Ä?Ä
  { id: "send", label: "Î∞úÏÜ°?òÍ∏∞", shortLabel: "Î∞úÏÜ°", group: "send" },
  { id: "sendhub", label: "Î∞úÏÜ° ?ºÌÑ∞", shortLabel: "?ºÌÑ∞", group: "send" },
  { id: "drafts", label: "Draft Í≤Ä??, shortLabel: "Ï¥àÏïà", group: "send" },
  { id: "scheduler", label: "?§Ï?Ï§ÑÎü¨", group: "send" },
  { id: "replymacro", label: "?µÏû•Îß§ÌÅ¨Î°?, shortLabel: "Îß§ÌÅ¨Î°?, group: "send" },
  { id: "templates", label: "?úÌîåÎ¶?, group: "send" },

  // ?Ä?Ä ?¥ÏòÅ/Î™®Îãà?∞ÎßÅ ?Ä?Ä
  { id: "deliveryanalytics", label: "?ÑÎã¨ Î∂ÑÏÑù", shortLabel: "Î∂ÑÏÑù", group: "ops" },
  { id: "linkinspector", label: "ÎßÅÌÅ¨ Í≤Ä??, shortLabel: "ÎßÅÌÅ¨", group: "ops" },
  { id: "register", label: "Í≥ÑÏ†ï ?±Î°ù", shortLabel: "?±Î°ù", group: "ops" },
  { id: "group", label: "Í∑∏Î£π", group: "ops" },
  { id: "groupsearch", label: "Í∑∏Î£π Í≤Ä??, shortLabel: "Í≤Ä??, group: "ops" },
  { id: "autoreply", label: "?êÎèô ?ëÎãµ", shortLabel: "?êÎèô", group: "ops" },
  { id: "channelhub", label: "Ï±ÑÎÑê ?àÎ∏å", shortLabel: "?àÎ∏å", group: "ops" },

  // ?Ä?Ä AI ?ÑÍµ¨ ?Ä?Ä
  { id: "myai", label: "?òÎßå??AI", shortLabel: "AI", group: "ai" },
  { id: "aireply", label: "AI ?µÏû•", shortLabel: "?µÏû•", group: "ai" },
  { id: "aibroadcast", label: "AI Î∞úÏÜ°", shortLabel: "AIÎ∞úÏÜ°", group: "ai" },
  { id: "aioperations", label: "AI Î¶¨Ìè¨??, shortLabel: "Î¶¨Ìè¨??, group: "ai" },
  { id: "aiopscenter", label: "AI ?¥ÏòÅ?ºÌÑ∞", shortLabel: "?¥ÏòÅ", group: "ai" },
  { id: "aiusage", label: "AI ?¨Ïö©??, shortLabel: "?¨Ïö©??, group: "ai" },

  // ?Ä?Ä ?§Ï†ï/Í∏∞Ì? ?Ä?Ä
  { id: "team", label: "?Ä Í¥ÄÎ¶?, shortLabel: "?Ä", group: "settings" },
  { id: "profile", label: "?ÑÎ°ú??, group: "settings" },
  { id: "guestbot", label: "Guest Î¥?, shortLabel: "Î¥?, group: "settings" },
  { id: "stars", label: "Stars Í≤∞Ï†ú", shortLabel: "Í≤∞Ï†ú", group: "settings" },
  { id: "folders", label: "?¥Îçî", group: "settings" },
  { id: "apikeys", label: "API ??, shortLabel: "API", group: "settings" },
  { id: "audit", label: "?úÎèô Î°úÍ∑∏", shortLabel: "?úÎèô", group: "settings" },
  { id: "triggers", label: "?êÎèô??Í∑úÏπô", shortLabel: "Í∑úÏπô", group: "settings" },
  { id: "referral", label: "Ï∂îÏ≤ú??, shortLabel: "Ï∂îÏ≤ú", group: "settings" },
  { id: "operator", label: "AI ÏßÅÏõê", shortLabel: "ÏßÅÏõê", group: "ai" },
  { id: "styleprofile", label: "Î∏åÎûú????, shortLabel: "??, group: "ai" },
  { id: "growthloop", label: "?±Ïû• Î£®ÌîÑ", shortLabel: "?±Ïû•", group: "ai" },
  { id: "fortune", label: "?¥ÏÑ∏", shortLabel: "?¥ÏÑ∏", group: "new" },
  { id: "telegram", label: "Telegram", shortLabel: "Ï±ÑÌåÖ", group: "send" },
  { id: "pixeloffice", label: "?ñ•Ô∏?AI ?¨Î¨¥??, shortLabel: "?¨Î¨¥??, group: "ai" },
];
...
export function getAccountInitials(account: Account): string {
  const source = account.name?.trim() || account.phone.replace(/[^0-9A-Za-zÍ∞Ä-??/g, "");
...
export const RECURRING_INTERVALS = [
  { value: 30, label: "30Î∂? },
  { value: 60, label: "1?úÍ∞Ñ" },
  { value: 120, label: "2?úÍ∞Ñ" },
  { value: 180, label: "3?úÍ∞Ñ" },
  { value: 360, label: "6?úÍ∞Ñ" },
  { value: 720, label: "12?úÍ∞Ñ" },
  { value: 1440, label: "24?úÍ∞Ñ" },
] as const;
...
// ?Ä?Ä?Ä Reply Macro (?µÏû•Îß§ÌÅ¨Î°? ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
...
// ?Ä?Ä?Ä Delivery Analytics ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
...
// ?Ä?Ä?Ä Per-endpoint Delivery Analytics types (DeliveryAnalyticsTab) ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
...
// ?Ä?Ä?Ä Group Folders (per-account, backend-persisted) ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
...
// ?Ä?Ä?Ä Account Groups (localStorage only) ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
