...
const STEPS: Step[] = [
  ...
  },
  {
    title: "메시지 발송",
    description:
      "여러 계정으로 동시에 메시지를 발송하고, 템플릿을 활용해 반복 작업을 자동화하세요. 예약 발송으로 최적의 시간에 도달률을 높일 수 있습니다.",
    icon: "📨",
  },
  {
    title: "AI 자동화",
    description:
      "AI 비서가 자동 응답, 스팸 필터링, 메시지 최적화를 도와줍니다. 매크로 편집기로 나만의 자동화 워크플로우를 만드세요.",
    icon: "🤖",
  },
  {
    title: "분석 & 성장",
    description:
      "발송 성과, 그룹 성장, 계정 헬스 스코어를 대시보드에서 추적하세요. 데이터 기반으로 캠페인을 최적화하고 채널을 성장시키세요.",
    icon: "📊",
  },
];
