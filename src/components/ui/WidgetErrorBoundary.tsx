    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-app-danger/20 bg-app-danger-muted/10 p-4 text-center">
          ...
          <p className="text-[11px] text-app-text-muted">이 위젯을 불러오는 중 오류가 발생했습니다</p>
          <button
            onClick={this.handleRetry}
            className="flex items-center gap-1.5 rounded-lg border border-app-border px-3 py-1.5 text-[11px] text-app-text hover:bg-app-card-hover transition-colors"
          >
