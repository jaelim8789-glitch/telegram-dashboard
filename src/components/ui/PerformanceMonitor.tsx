...
export function PerformanceMonitorUI() {
  ...
  useEffect(() => {
    ...
    const updateMetrics = () => {
      ...
      // ?„ì¬ ?±ëŠ¥ ì§€?œë? ?íƒœ???€??      const newMetrics: PerformanceMetric[] = [
        {
          name: 'DOM ë¡œë”© ?œê°„',
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-gray-900 text-white p-4 rounded-lg shadow-xl z-50 max-w-md w-full">
      <div className="flex justify-between items-center mb-3">
        <h3 className="font-bold">?±ëŠ¥ ëª¨ë‹ˆ?°ë§</h3>
        <button
      ...
      <div className="space-y-2 max-h-60 overflow-y-auto">
        ...
        {issues.length > 0 && (
          <div className="mt-3 pt-3 border-t border-gray-700">
            <h4 className="font-bold text-red-400 mb-2">?±ëŠ¥ ?´ìŠˆ:</h4>
