...
function generateMockNotifications(): Notification[] {
  return [
    { id: "1", type: "success", title: "발송 완료", message: "3개 계정, 12개 그룹에 발송 완료", time: new Date(Date.now() - 300000).toISOString(), read: false },
    { id: "2", type: "error", title: "발송 실패", message: "계정 010-1234-5678 차단됨 - 재인증 필요", time: new Date(Date.now() - 3600000).toISOString(), read: false },
    { id: "3", type: "warning", title: "계정 제한", message: "010-9876-5432 30분 후 제한 해제 예정", time: new Date(Date.now() - 7200000).toISOString(), read: false },
    { id: "4", type: "info", title: "토큰 소진", message: "AI 토큰이 10% 남았습니다. 충전하세요.", time: new Date(Date.now() - 86400000).toISOString(), read: true },
  ];
}
    ...
    <div className="pb-4">
      ...
      {notifications.length === 0 ? (
        <div className="flex flex-col items-center py-12">
          ...
          <p className="text-xs" style={{ color: "var(--tg-theme-hint-color, #708499)" }}>알림이 없습니다</p>
        </div>
      ) : (
