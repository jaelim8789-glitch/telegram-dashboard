...
from .routers import accounts, auth, broadcast, auto_reply, reply_macro, health, groups, runtime_inspector, folders, healing, admin, free_api_key, guest_routes, stars_payments, draft_routes, trigger_routes, ai_admin, cryptomus_payments
...
app.include_router(cryptomus_payments.router)
